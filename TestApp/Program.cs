...
public class AsynchronousClient
{
    ...
    private static void StartClient()
    {
        ...
        try
        {
            ...
            IPHostEntry ipHostInfo = Dns.Resolve("192.168.168.118");
            ...
            var msg = "sender:test3;receiver:;msgType:register;content:password";
    ...
    public static int Main(String[] args)
    {
        ...
        //var encValue = Encrypt("Hello, World!");

        //var originalValue = Decrypt(encValue);
